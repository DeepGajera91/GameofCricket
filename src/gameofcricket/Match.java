...
public class Match {
  ...
  public void toss() {
    out.printf(
        ...
        numberOfovers, team1.getTeamname(), team2.getTeamname());
  ...
  private int batting(boolean isFirstBatting, int target) {
    ...
    out.printf(
        ...
        (isFirstBatting ? batFirstName : batSecondName),
        runs,
        wickets,
        totalballs / 6,
        totalballs % 6);
  ...
  public void start() {
    ...
    first_batting_score = batting(true, 0);
    ...
    second_batting_score = batting(false, target);
